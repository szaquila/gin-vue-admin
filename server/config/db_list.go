...
type GeneralDB struct {
	...
	ConnMaxIdleTime int    `mapstructure:"conn-max-idle-time" json:"conn-max-idle-time" yaml:"conn-max-idle-time"` // 连接最大闲置时间
	ConnMaxLifetime int    `mapstructure:"conn-max-lifetime" json:"conn-max-lifetime" yaml:"conn-max-lifetime"`    // 连接最大生命周期
